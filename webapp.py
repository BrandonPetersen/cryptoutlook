...
from helpers import apology, login_required, usd, lookup1
...
def index():
    ...
    globaldatas = requests.get("https://api.coingecko.com/api/v3/global", headers = {"accept" : "application/json"})
    
    globaldata = globaldatas.json()
    
    return render_template("index.html", globaldata = globaldata, bitprice = bitprice, etherprice = etherprice, tetherprice = tetherprice, dogeprice = dogeprice, bitcap = bitcap, ethercap = ethercap, tethercap = tethercap,
